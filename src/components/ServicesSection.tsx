...
import { Globe, Monitor, Smartphone, BarChart3, MessageSquare, MessageCircleMore, Gift, Timer } from 'lucide-react';
    ...
    <div className="offer-burst-container">
      ...
      >
        <div className="offer-burst-inner">
          <div className="offer-burst-text">
            OFERTA
          </div>
        </div>
      </motion.div>
...
const ServicesSection = () => {
  ...
  const [promoData, setPromoData] = useState<{ active: boolean; endTime: number } | null>(null);
  ...
  const services = [
    {
      ...
      promo: {
        text: promoData?.active 
          ? <>¡Te hacemos tu landing page <span className="font-bold text-white">GRATIS</span>!</> 
          : <>Si todavía no tenés tu propia página o la que tenes no te gusta. <br /> ¡Te la hacemos GRATIS!</>,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          {services.map((service, index) => (
            ...
            >
              <div className={`offer-card-container h-full bg-white/5 backdrop-blur-lg rounded-2xl p-6 border ${
